...
public class FacadeWatcher {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(FacadeWatcher.class);
    ...
    public void logEvent(OrderDto orderDto, Long userId, Object object) {
        LOGGER.info("Class: " + object.getClass().getName() + " OrderDto: " + orderDto.toString() + " UserId: " + userId);
    }
